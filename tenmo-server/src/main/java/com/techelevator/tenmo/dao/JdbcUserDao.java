...
public class JdbcUserDao implements UserDao {
    ...
    public String getUsernameFromAccount(int id) {
        String getUsername = jdbcTemplate.queryForObject("SELECT username FROM tenmo_user tu JOIN account a ON tu.user_id = a.user_id WHERE account_id = ?", String.class, id);
        return getUsername;
    }

    @Override
    public int getAccountId(int id) {
        int getAccountId = jdbcTemplate.queryForObject("SELECT account_id from account a JOIN tenmo_user tu ON a.user_id = tu.user_id WHERE tu.user_id = ?", int.class, id);
        return getAccountId;
    }
    @Override
